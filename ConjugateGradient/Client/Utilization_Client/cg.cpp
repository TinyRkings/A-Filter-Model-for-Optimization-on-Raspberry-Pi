...
//nonzero min(m,n) *1
double *r8sp_1nznum ( int m, int n, int nz_num, int row[], int col[] )
{
  double *a;
  int i;
  int j;
...
//nonzero min(m,n) *2
double *r8sp_2nznum ( int m, int n, int nz_num, int row[], int col[] )
{
  double *a;
  int i;
  int j;
...
//nonzero min(m,n) *9
double *r8sp_9nznum ( int m, int n, int nz_num, int row[], int col[] )
{
  double *a;
  int i;
  int j;
